...
class AiLocationWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: const Text('Address Dialog'),
      content: SizedBox(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final subAddress = _controller.subAddresses[index];
                      return ListTile(
                        ...
                        onTap: () {
                          _controller.selectedAddress.value = subAddress;
                          _controller.loadSubAddressDetails(subAddress.code);
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final subAddresses1 = _controller.subAddresses1[index];
                      final bool lastIsSelected =
                          subAddresses1 == _controller.selectedAddress.value;
                      return ListTile(
                        tileColor:
                            lastIsSelected ? Colors.grey : Colors.transparent,
                        title: Text(
                          subAddresses1.name,
                          style: const TextStyle(
                            fontSize: 13,
                        ...
                        onTap: () {
                          _controller.subAddresses1R(subAddresses1.name);
                          _controller.selectedAddress.value = subAddresses1;
                          _controller.update();
